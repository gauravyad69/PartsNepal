...
import np.com.parts.Presentation.Adapter.OrderItemsAdapter
import np.com.parts.Domain.ViewModels.OrderViewModel
        ...
        binding.pay.setOnClickListener{
            args.orderNumber?.let { orderNumber ->
                findNavController().navigate(
                    OrderDetailsFragmentDirections.Companion.actionOrderDetailsFragmentToPaymentFragment(
